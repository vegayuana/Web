...
<body>
	...
	<div class="bg">
		<a href="http://localhost/ciweb/index.php/adv/news" >News</a>
		<a href="http://localhost/ciweb/index.php/adv/tickettour">Tours & Ticket</a>
		<a href="http://localhost/ciweb/index.php/adv/merch">Merch</a>
	</div>
	
	<footer class="foot">
		<p>Connect With Us</p>
		<a href="https://www.gmail.com"><image src="<?php echo base_url(); ?>static/icon/mail.png" alt="mail" style="width:45px; height:45;"></a>
