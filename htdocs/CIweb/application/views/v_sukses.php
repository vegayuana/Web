...
<html>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>static/css/suksesstyle.css">
    </head>
</html>
<body>
	<div class="logo">
	...
	<div class="bg">
        <center>
            <div class="bagian">
                <div class="isi">
                <p1>Pemesanan Berhasil!</p1><br><br><br>
                <p2>Detail pemesanan akan dikirim ke email anda</p2><br><br><br>
                <p3>Terima kasih</p3>
                </div>
            </div>
        </center>
